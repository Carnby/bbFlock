...
define('BB_DEFAULT_THEME', 'core#merlot');
define('BB_DEFAULT_THEME_DIR', BB_CORE_THEME_DIR . 'merlot/');
define('BB_DEFAULT_THEME_URL', BB_CORE_THEME_URL . 'merlot/');
...
// load functions.php from template
if ($theme_functions_file = bb_get_template('functions.php'))
